...
describe ReportingController do
  ...
  context '#index' do
    ...
    it 'fetches data' do
      expect_any_instance_of(RealReportingInteractor).to receive(:fetch_projection_data)
      get :index
    end
  ...
  context 'authentication failure' do
    it 'displays an error message' do
      allow_any_instance_of(RealReportingInteractor).to receive(:fetch_projection_data).and_raise(RealReportingInteractor::AuthenticationError.new)
